...
-- Add index for faster lookups of AI-assisted searches
CREATE INDEX IF NOT EXISTS idx_saved_searches_assisted_query
ON papersorter.saved_searches(assisted_query)
WHERE assisted_query IS NOT NULL;
